...
// Inicialización de Magnific Popup para el modal de reclutamiento
$('.lightbox-inline').magnificPopup({
    type: 'inline',
    midClick: true, // Permite que se cierre el popup con un clic medio/botón derecho
    removalDelay: 500, // Tiempo de espera antes de remover el modal (para la animación CSS)
    mainClass: 'mfp-zoom-in' // Clase CSS para la animación (asegúrate de que exista en tu CSS)
});
